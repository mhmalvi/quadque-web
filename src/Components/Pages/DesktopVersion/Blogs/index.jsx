...
const Blogs = () => {
  return (
    <div
      id="blogs"
      className="section w-full lg:py-10 2xl:py-12  font-poppins bg-black"
    >
      <div className="flex justify-center items-center text-[#EDEDED] my-auto">
        <div className="relative w-[70%] max-h-[95vh] mr-1">
          <img className="min-w-full max-h-[95vh] my-auto" src={blog1} alt="" />
          <div
            ...
            <div className="flex items-center mt-2.5">
              ...
              <div className="ml-8">
                <div className="text-[22px] font-normal leading-8">
                  ...
                  <span className="text-brand-color font-bold">in</span> Random
                  Category
                </div>
        ...
        <div className="w-[30%] max-h-[95vh] ml-1">
          ...
          <div className="relative">
            <img className="h-full w-full" src={moreBlogs} alt="" />
            <div
