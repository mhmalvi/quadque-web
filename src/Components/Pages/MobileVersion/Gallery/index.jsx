...
import Blog from "../../../../asstes/Images/blog3.jpg"
...
const Gallery = () => {
  ...
  return (
    <div className="w-full relative pt-30">
      <img src={Blog} alt="" className="absolute top-0 w-full h-81"/>
      <div className="absolute w-full flex items-end h-56 bg-gradient-to-b from-transparent to-black text-2xl text-white px-6 pb-10">Gallery</div>
